...
// Lista estática de cartas usando IDs de recursos (R.drawable)
// Esto sirve como fallback si la API no está disponible
fun getInitialCards(context: Context): List<Card> {
    return listOf(
